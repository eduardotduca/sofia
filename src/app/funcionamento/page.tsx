...
const navigation = [
  ...
  { name: "Sobre nós", href: "https://wa.me/" },
];
...
export default function Funcionamento() {
  ...
  return (
    <div className="bg-white">
      ...
      <main>
        {/* Hero section */}
        <div className="relative isolate pt-14 pb-6">
          <svg
          ...
          <div className="mx-auto max-w-7xl px-6 py-24 lg:flex lg:items-center lg:gap-x-10 lg:px-8 ">
            <div className="mx-auto max-w-3xl lg:mx-0 lg:flex-auto">
              ...
              <p className="mt-6 text-lg leading-8 text-gray-600">
                ...
                voluptatum id quia enim odio tempora voluptatem sit blanditiis
                et quisquam. Tempora atque quis cumque est consequatur facilis
        ...
        <div className="mx-auto max-w-7xl px-6 py-24 lg:flex lg:items-center lg:gap-x-10 lg:px-8 ">
          <div className="mx-auto max-w-6xl lg:mx-0 lg:flex-auto">
            <h1 className="mt-10 max-w-lg text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl">
              Versões
            </h1>
